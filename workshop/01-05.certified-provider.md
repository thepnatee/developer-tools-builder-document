...
ขั้นตอนการได้รับ Certified Provider:

1. **Provider ปกติ** → สมัคร Certified Application
2. **LINE พิจารณา** (~10 วันทำการ)
   - ไม่ผ่าน → กลับไปแก้ไขและยื่นใหม่
   - ผ่าน → ได้สถานะ **Certified Provider**

เมื่อได้ Certified Provider จะได้รับสิทธิ์:
- **Certified Badge** — แสดงในหน้า Consent
- **Auto Check Add Bot** — ใน LIFF/LINE Login
- **ขอใช้ Special API ได้** (Stay, Profile+, Mark-as-read)
  - Stay Event Application — ต้องขอแยกเป็นรายกรณี
