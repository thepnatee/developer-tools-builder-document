...
1. กำหนดโจทย์: ใบเสร็จ 7-Eleven
2. เขียน Prompt ให้ ChatGPT
3. ได้ JSON เวอร์ชันแรก
4. วาง JSON ใน Flex Simulator
5. ตรวจสอบผลลัพธ์:
   - **แสดงผลไม่ถูก** → แก้ใน Simulator หรือบอก ChatGPT ให้ปรับ แล้วกลับไปข้อ 4
   - **แสดงผลถูก** → ส่งผ่าน LINE Bot จริง
6. เก็บภาพผลลัพธ์
