...
ขั้นตอนการใช้งาน Postman กับ LINE API:

1. นักพัฒนา Import Collection จาก GitHub URL เข้า Postman
2. Postman แสดงรายการ endpoint ทั้งหมด
3. นักพัฒนาตั้งค่า environment: `channelAccessToken`, `userId`
4. นักพัฒนาคลิก request ที่ต้องการ แล้วกด Send
5. Postman ส่ง HTTP request พร้อม header + body ไปยัง LINE API
6. LINE API ส่ง JSON response กลับ
7. นักพัฒนาเห็นผลทันทีใน Postman UI
...
| `replyToken` | reply token (ใช้ภายใน 20 นาทีหลังรับ event) |
...
- **พลาด:** ใช้ replyToken ที่ copy มาจากเมื่อวาน แล้วยิง reply message แล้วได้ 400
  **ถูก:** replyToken มีอายุเพียง **20 นาที** และใช้ได้ครั้งเดียว — ต้องเอามาจาก webhook event ล่าสุด
