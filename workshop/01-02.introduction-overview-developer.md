...
**LINE Developers** ประกอบด้วยบริการหลัก 7 ตัว:

- **Messaging API** — ส่ง/รับข้อความ (ผูกกับ LINE OA)
- **LIFF** — Web app ใน LINE (ผูกกับ LINE OA)
- **LINE Login** — ล็อกอินด้วย LINE
- **LINE Pay** — รับชำระเงิน
- **LINE Beacon** — แจ้งเตือนตามสถานที่
- **LINE Mini App** — Web app เต็มรูปแบบ เบื้องหลังคือ LIFF (ผูกกับ LINE OA)
- **LON** — ส่งข้อความด้วยเบอร์มือถือ
