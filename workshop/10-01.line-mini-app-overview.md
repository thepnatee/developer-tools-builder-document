...
- นักพัฒนา → สร้างแชนเนลใน LINE Developers Console → เลือกประเภท MINI App:
  - **Unverified MINI App** (ไม่ส่งตรวจ) → ใช้ฟีเจอร์ LIFF พื้นฐาน → ผู้ใช้งาน LINE
  - **Verified MINI App** (ส่งเอกสารตรวจ, ผ่านรีวิว) → ฟีเจอร์ครบ + Service Message + Shortcut + Search → ผู้ใช้งาน LINE
...
- **Verified MINI App** — ต้องยื่นเอกสารกับ LINE เพื่อรับการตรวจสอบและเผยแพร่ขึ้น Production โดย **สำหรับประเทศไทยและไต้หวัน** channel ต้องอยู่ภายใต้ **Certified Provider** จึงจะสมัครขอ Verified ได้
...
- ต้องการฟีเจอร์พิเศษ (Service Message, Shortcut, Search)?
  - **ไม่ต้องการ** → Unverified MINI App → ขึ้น Production ได้เลย (ใช้งานได้ทันที)
  - **ต้องการ** → Verified MINI App → ส่งเอกสารให้ LINE ตรวจสอบ → รอ Review → ขึ้น Production พร้อมฟีเจอร์ครบ
    > **ไทย/ไต้หวัน:** ต้องเป็น Certified Provider ก่อนจึงจะสมัคร Verify ได้ (ดู [01-05.certified-provider.md](01-05.certified-provider.md))
...
- ต้องการหลาย LIFF ในแชนเนลเดียว?
  - **Yes** → LIFF ใน LINE Login
  - **No** → ต้องการเปลี่ยนขนาด Full/Tall/Compact?
    - **Yes** → LIFF ใน LINE Login
    - **No** → ต้องการ Service Message, Shortcut, Search?
      - **Yes** → Verified MINI App
      - **No** → Unverified MINI App หรือ LIFF ก็ได้
...
- **พลาด:** ปุ่มหรือ content ที่วางชิดล่างสุดถูก Android nav bar ทับ (LINE v26+, มี.ค. 2026)
  **ถูก:** Android edge-to-edge ทำให้ LIFF และ LINE MINI App ถูก nav bar ทับ — เพิ่ม `padding-bottom: env(safe-area-inset-bottom)` ใน CSS ของทุก page ที่มี content / button ชิดล่าง

- **พลาด:** สร้าง MINI App channel ใหม่ใน Japan แล้วไม่ได้เปิด Channel Consent Simplification
  **ถูก:** ตั้งแต่ 8 ม.ค. 2026 MINI App channel ใหม่ใน Japan **บังคับ** ต้องใช้ Channel Consent Simplification — ต้องตั้งค่าในระหว่างสร้าง channel ไม่ใช่ทีหลัง
...
- **พลาด:** (ไทย/ไต้หวัน) สมัคร Verified MINI App โดยยังไม่ได้เป็น Certified Provider
  **ถูก:** สำหรับไทยและไต้หวัน channel ต้องอยู่ภายใต้ **Certified Provider** เท่านั้นจึงจะส่งเรื่องขอ Verified ได้ — ต้องผ่านการอนุมัติจาก LINE ท้องถิ่นก่อน (ดู [01-05.certified-provider.md](01-05.certified-provider.md))
