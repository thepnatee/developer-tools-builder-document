...
**ขั้นตอนการ Add to Home Screen:**

1. ผู้ใช้กดปุ่ม "Add to Home Screen" ใน MINI App
2. MINI App เรียก `liff.createShortcutOnHomeScreen({url})`
3. ระบบ Redirect ไปที่เว็บไซต์ LINE ในเบราว์เซอร์เริ่มต้นของอุปกรณ์
4. LINE แสดงคำแนะนำให้ผู้ใช้ "Add to Home Screen"
5. ผู้ใช้ยืนยันเพิ่มทางลัด → ไอคอนปรากฏบน Home Screen
6. ครั้งถัดไป: ผู้ใช้แตะไอคอน → OS เปิด MINI App ทันที
