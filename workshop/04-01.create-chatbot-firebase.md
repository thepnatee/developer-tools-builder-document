...
ลำดับการทำงานของ LINE Chatbot บน Firebase:

1. ผู้ใช้ LINE พิมพ์ข้อความ / กด Rich Menu
2. LINE Platform ส่ง POST webhook event ไปยัง Firebase Cloud Functions
3. Firebase Cloud Functions ประมวลผล event
4. อ่าน/เขียนข้อมูลกับ Firestore (optional)
5. Firebase Cloud Functions ส่ง Reply / Push Message ไปยัง LINE Platform
6. LINE Platform แสดงข้อความตอบกลับให้ผู้ใช้
