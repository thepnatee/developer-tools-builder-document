# Workshop: เปิด LINE Official Account
...
ขั้นตอนการเปิด LINE Official Account:

1. ผู้ใช้งาน/เจ้าของธุรกิจ → เข้า LINE OA Manager (manager.line.biz)
2. สร้าง LINE Official Account
3. กรอกข้อมูลธุรกิจ (ชื่อ / อีเมล / ประเทศ)
4. Enable Messaging API
5. เลือก/สร้าง Provider
6. เข้า LINE Developers Console (developers.line.biz)
7. จัดการ Channel (icon / name / description)

## ขั้นตอนการเปิดบัญชี

> **อัปเดต (25 มิ.ย. 2025):** ตั้งแต่ช่วงกลางปี 2025 การสร้าง LINE Official Account ใหม่จำเป็นต้องเชื่อมต่อกับ **LINE Business Manager** ก่อน ขั้นตอนการสร้างและหน้า UI บางส่วนอาจดูต่างจาก screenshot เก่า — ให้ยึดขั้นตอนหลักเป็นแนวทาง และทำตามคำแนะนำบนหน้าจอ ณ ขณะที่สร้างจริง
