...
1. `npx create-liff-app`
2. ตอบคำถาม: framework, language, LIFF ID
3. `cd <project>` + `npm install`
4. `npm run dev` → เปิดที่ `localhost:5173`
5. Port Forward เพื่อเปิด public HTTPS URL
6. ใส่ URL ใน LIFF Endpoint URL บน LINE Developers Console
7. เปิด LIFF URL ในห้องแชทเพื่อทดสอบ
