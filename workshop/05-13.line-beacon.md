...
1. ผู้ใช้เดินเข้าระยะ 25 เมตรจาก LINE Beacon Device (BLE)
2. Beacon Device ส่งสัญญาณ BLE พร้อม HWID ไปยังมือถือผู้ใช้
3. มือถือผู้ใช้รายงาน Beacon detection ไปยัง LINE Platform
4. LINE Platform ส่ง webhook event (type=beacon, mode=enter) ไปยัง Bot Server
5. Bot Server ค้นหา hwid เพื่อระบุสาขา/พื้นที่
6. Bot Server ส่ง reply/push คูปองกลับไปยัง LINE Platform
7. LINE Platform ส่งข้อความให้ผู้ใช้เห็นใน LINE chat
...
| `replyToken` | ใช้ตอบกลับผู้ใช้ (20 นาที / single use) |
