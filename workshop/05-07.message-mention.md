...
> **หมายเหตุ:** คุณยังคงสามารถใช้ข้อความแบบเดิม (text message v1) ได้ อย่างไรก็ตาม LINE อาจเพิ่มฟีเจอร์ใหม่ ๆ ให้กับข้อความแบบ v2 เท่านั้นในอนาคต ดังนั้นแนะนำให้เริ่มใช้ text message v2 สำหรับการพัฒนาใหม่
...
ข้อความเวอร์ชันใหม่ (v2) ถูกออกแบบมาให้สามารถแทนที่ข้อความที่อยู่ภายใน `{` และ `}` ด้วย mentions หรือ emojis ได้โดยอัตโนมัติ
โดยต้องกำหนดรายละเอียดของสิ่งที่จะแทนที่ไว้ในคุณสมบัติ `substitution`

สามารถตรวจสอบรายการ LINE emoji ที่รองรับได้ที่ [LINE emoji list](https://developers.line.biz/en/docs/messaging-api/emoji-list/)

สำหรับรายละเอียดเพิ่มเติมของ text message v2 ดูได้ที่ [Text message (v2)](https://developers.line.biz/en/reference/messaging-api/#text-message-v2) ใน Messaging API reference
