# Workshop: Message Mention (Text v2)
...
การทำงานของ Text v2 Mention:

- ข้อความ: `"Welcome {user1} {laugh}!"`
- **substitution** ที่กำหนด:
  - `user1` → mention userId=U123
  - `laugh` → emoji (productId + emojiId)
- LINE Platform แปลง substitution → `@สมชาย 😂`
- ผู้ใช้เห็น mention และได้รับ notification
