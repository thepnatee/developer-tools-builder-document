...
1. ผู้ใช้ LINE ส่งรูปภาพเข้ามาในแชท
2. LINE Platform ส่ง webhook event (message.image) ไปยัง Bot
3. Bot ดาวน์โหลด binary ไฟล์จาก LINE (GET content)
4. Bot อัปโหลดไฟล์ไปยัง Firebase Storage (getDownloadURL)
5. Firebase Storage ส่ง HTTPS URL พร้อม token กลับมาให้ Bot
6. Bot บันทึก URL ลง Firestore (ทางเลือก)
7. Bot ส่ง reply Flex Message พร้อม URL รูปไปยัง LINE Platform
8. LINE Platform แสดงรูปใน Flex Message ให้ผู้ใช้เห็น
