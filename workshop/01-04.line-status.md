...
ขั้นตอนตรวจสอบเมื่อบอท/LIFF มีปัญหา:

1. เปิด [api.line-status.info](https://api.line-status.info)
2. ดูสถานะฝั่ง LINE:
   - **Operational** → ปัญหาอยู่ที่โค้ดเรา ไป debug ต่อ
   - **Degraded / Outage** → รอ LINE แก้, ติดตาม update, แจ้งลูกค้าว่าเป็นที่ LINE
