...
ลำดับการทำงานของ Loading Animation:

1. ผู้ใช้ส่งคำถามไปยัง LINE
2. LINE ส่ง webhook event ไปยัง Bot
3. Bot ส่ง `POST /chat/loading/start` (loadingSeconds: 15) → แสดง "..." 15 วินาทีให้ผู้ใช้เห็น
4. Bot เรียก ChatGPT/Backend API (ใช้เวลาประมาณ 8 วินาที)
5. ChatGPT/Backend ตอบกลับ Bot
6. Bot ส่ง `POST /message/reply` → "..." หายไปอัตโนมัติ
7. LINE ส่งคำตอบให้ผู้ใช้
