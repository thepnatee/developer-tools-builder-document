...
วิธีเลือก API สำหรับส่งข้อความจาก LIFF:

- **เปิดอยู่ใน browser นอก LINE** → ใช้ `shareTargetPicker` (ผู้ใช้เลือกเพื่อน/กรุ๊ปก่อนส่ง)
- **เปิดอยู่ใน LINE app** → ตรวจสอบว่าต้องการส่งที่ไหน:
  - **ส่งเข้าแชทเดิมที่เปิด LIFF อยู่** → ใช้ `sendMessages` (ปรากฏเหมือนผู้ใช้ส่งเอง)
  - **ให้ผู้ใช้เลือกปลายทางเอง** → ใช้ `shareTargetPicker` (ผู้ใช้เลือกเพื่อน/กรุ๊ปก่อนส่ง)
